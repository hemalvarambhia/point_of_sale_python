...
class FormattingMonetaryAmountsTest(unittest.TestCase):
    ...
    def test_formatting_amounts_between_one_pound_and_under_one_thousand_pounds(self):
        self.assertEqual("£999.00", WesternMonetaryAmountFormatter.format_monetary_amount(99900))

    def test_formatting_exactly_one_thousand_pounds(self):
        self.assertEqual("£1,000.00", WesternMonetaryAmountFormatter.format_monetary_amount(100000))

    def test_formatting_thousand_pounds_and_some_pence(self):
        self.assertEqual("£1,000.99", WesternMonetaryAmountFormatter.format_monetary_amount(100099))

    def test_formatting_tens_of_thousands_pounds_exactly(self):
        self.assertEqual("£10,000.00", WesternMonetaryAmountFormatter.format_monetary_amount(1000000))
